...
function checkUtts() {
  ...
  $('.parse').each(function() {
    u = $(this).clone()
    u.find('.span-grade-selector, .entity-user-data, .label, .other-grades').remove().text().trim().toLowerCase();
...
function searchLinks() {
  $('.parse').each(function() {
    u = $(this).clone()
    u.find('.span-grade-selector, .entity-user-data, .label, .sims, .other-grades').remove().text().trim().toLowerCase();
